...
TEST(PlayerTests, ShowMyHunters_AcceptsOrderedSet)
{
    chk::Player player{chk::PlayerType::PLAYER_RED};
    ...
    std::unordered_set<int32_t> hunterPieces{1};
    player.showMyHunters(hunterPieces);

    EXPECT_TRUE(player.hasThisPiece(1));
}
