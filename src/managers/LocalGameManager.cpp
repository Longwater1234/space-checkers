 ...
 */
LocalGameManager::LocalGameManager(sf::RenderWindow *windowPtr) : GameManager(windowPtr)
{
 ...
 */
void LocalGameManager::createAllPieces()
{
 ...
 */
void LocalGameManager::handleEvents(chk::CircularBuffer<short> &buffer)
{
 ...
 */
std::array<short, chk::NUM_PIECES> LocalGameManager::generateRandomPieceIds()
{
