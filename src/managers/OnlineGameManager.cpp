...
OnlineGameManager::OnlineGameManager(sf::RenderWindow *windowPtr) : GameManager(windowPtr)
{
 ...
 */
void chk::OnlineGameManager::createAllPieces()
{
 ...
 */
void OnlineGameManager::drawBoard()
{
 ...
 */
void OnlineGameManager::handleEvents(chk::CircularBuffer<short> &buffer)
{
 ...
 */
void OnlineGameManager::handleMovePiece(const chk::PlayerPtr &player, const chk::PlayerPtr &opponent,
 ...
 */
void OnlineGameManager::handleCapturePiece(const chk::PlayerPtr &hunter, const chk::PlayerPtr &prey,
 ...
 */
void OnlineGameManager::handleCellTap(const chk::PlayerPtr &hunter, const chk::PlayerPtr &prey,
 ...
 */
void OnlineGameManager::startMoveListener()
{
 ...
 */
void OnlineGameManager::startCaptureListener()
{
 ...
 */
void OnlineGameManager::startDeathListener()
{
