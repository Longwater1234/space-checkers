 ...
 */
void Player::losePiece(const int targetId)
{
 ...
 */
void Player::showMyHunters(const std::unordered_set<int> &hunterPieces) const
{
 ...
 */
const std::unordered_map<int, chk::PiecePtr> &Player::getOwnPieces() const
{
    return this->basket;
}
 ...
 */
bool Player::hasThisPiece(const int pieceId) const
{
 ...
 */
bool Player::movePiece(const int pieceId, const sf::Vector2f &destPos)
{
 ...
 * \return TRUE if successful, else FALSE
 */
bool Player::captureEnemyWith(const int pieceId, const sf::Vector2f &destPos)
{
